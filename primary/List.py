...
# 列表名[起始位置:结束位置:间隔数] 切片,返回一个列表(新的对象)
...
# 生成列表
lst = [i for i in range(1, 10)]  # [列表元素 for 变量 range(起始范围,结束范围)]
print(lst)
